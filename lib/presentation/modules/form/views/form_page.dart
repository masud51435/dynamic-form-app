                    ...
                    children: [
                      ...
                      ...section.fields.map((field) {
                        return FieldWidgetFactory.build(
                          ...
                          onChanged: (val) => controller.updateField(field.key, val),
                          onImagePicked: (images) => controller.updateImage(field.key, images),
                        );
                      }),
                ...
                ElevatedButton(
                  onPressed: () {
                    if (controller.validateForm()) {
                      Get.toNamed(Routes.SUBMISSION, arguments: {
                        'form': controller.form,
                        'values': controller.fieldValues,
                        'images': controller.imageFiles,
                      });
                    } else {
                      Get.snackbar("Validation", "Please fix errors before submitting.");
                    }
                  },
